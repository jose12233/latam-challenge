...
# Función para medir la memoria
def memory_optimized_emoji_counter():
    current_dir = os.path.dirname(os.path.abspath(__file__))
    file_path = os.path.join(current_dir, '..', 'farmers-protest-tweets-2021-2-4.json')

    # Medir el uso de memoria
    mem_usage = memory_usage((count_emojis_in_content, (file_path,)))
...
# Proteger la ejecución del script
if __name__ == '__main__':
    memory_optimized_emoji_counter()
